...
const QUOTES = [
  "La arquitectura es la voluntad de una época concebida en términos de espacio.",
  "Toda arquitectura es un combate contra la gravedad.",
  "La luz es el primer elemento del diseño arquitectónico.",
];
...
export default function ArquitecturaSection() {
  ...
  useEffect(() => {
    base44.functions
      .invoke("listDriveImages", { folderPath: "Web/06-arquitectura" })
  ...
  return (
    <section id="arquitectura" className="py-24 md:py-32 px-8 md:px-16">
      <SectionHeader
        number="04"
        title="Arquitectura"
        description="La piedra y el cielo. Estructuras que desafiaron siglos y gravedad."
      />
      ...
      {loading ? (
        ...
        >
          ...
          >
            <Building2 size={18} strokeWidth={1.5} style={{ color: "#8C867A" }} />
            <p
