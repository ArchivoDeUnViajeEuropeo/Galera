...
const QUOTES = [
  "Todo viaje comienza mucho antes de partir.",
  "El aeropuerto es el primer destino de cualquier viaje.",
  "La anticipación es ya la mitad del viaje.",
];
...
export default function PreparativosSection() {
  ...
  useEffect(() => {
    base44.functions
      .invoke("listDriveImages", { folderPath: "Web/04-preparativos" })
  ...
  return (
    <section id="preparativos" className="py-24 md:py-32 px-8 md:px-16">
      <SectionHeader
        number="06"
        title="Preparativos"
        description="Aeropuertos, estaciones, trayectos. La anticipación antes del destino."
      />
      ...
      {loading ? (
        ...
        >
          ...
          >
            <Plane size={18} strokeWidth={1.5} style={{ color: "#8C867A" }} />
            <p
